...
public class BTypeTitleExtractor {
	...
	public List<String> extract(List<String> alter, BufferedImage image) {
		...
		SEARCH_WIDTH = (int)(BASE_HEADER_HEIGHT * 15); // 15자 검색범위
	...
	public static void main(String[] args) throws IOException {
        ...
        SpringApplication app = new SpringApplication(BTypeTitleExtractor.class);
		...
		System.out.println(bTypeTitleExtractor.extract(List.of("a", "b"), image));
	}
}