...
public class BTypeTitleExtractor {
	...
	public BTypeTitleExtractor(int dpi) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedImage image = ImageIO.read(new File("D:/pgm_data/test2/f7380e0d-537c-4c6a-88b7-64e42d1202f3"));
		System.out.println(new BTypeTitleExtractor(DPI).extract(List.of("a", "b"), image, tesseract));
	}
}